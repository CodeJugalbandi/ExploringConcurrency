...
**BRAHMA** We can make this parallel and speed-up the execution. Instead of creating ad-hoc threads I'll use a ThreadPool to re-use threads, put it back into the pool after they are used for a task and thus help with thread management.
